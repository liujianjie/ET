...
namespace ET
{
    ...
    [MemoryPackable]
    [Message(LoginOuter.C2G_GetServerTime)]
    [ResponseType(nameof(G2C_GetServerTime))]
    public partial class C2G_GetServerTime : MessageObject, ISessionRequest
    {
        public static C2G_GetServerTime Create(bool isFromPool = false)
        {
            return ObjectPool.Fetch<C2G_GetServerTime>(isFromPool);
        }
    ...
    [MemoryPackable]
    [Message(LoginOuter.G2C_GetServerTime)]
    public partial class G2C_GetServerTime : MessageObject, ISessionResponse
    {
        public static G2C_GetServerTime Create(bool isFromPool = false)
        {
            return ObjectPool.Fetch<G2C_GetServerTime>(isFromPool);
        }
    ...
    public static class LoginOuter
    {
        ...
        public const ushort C2G_GetServerTime = 1009;
        public const ushort G2C_GetServerTime = 1010;
    }
}